...
class MultKAN(nn.Module):
    ...
    def forward(self, x, singularity_avoiding=False, y_th=10.)-> torch.Tensor:
    ...
    def attribute(self):
        ...
        for l in range(self.depth,0,-1):
            ...
            # subnode to edge
            subnode_score = subnode_score.to(self.edge_actscale[l-1].device)
