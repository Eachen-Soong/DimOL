...
from neuralop.datasets.autoregressive_dataset import load_autoregressive_traintestsplit_new
...
def run(args):
    ...
    train_loader, test_loader = load_autoregressive_traintestsplit_new(
        data_path,
        n_train, n_test,
